import 'package:example/chips_input/app_chips_input_field.dart';
...
class MyApp extends StatelessWidget {
  MyApp({super.key});
  final ChipsInputController chipsInputController = ChipsInputController(
    initialChips: [],
  );
        ...
        body: Center(
          child: Column(children: [
            ...
            AppChipsInputField(
              ...
              // onChanged: (List<String> chips) => setState(() {}),
              //  autoFocus: chipsList.isEmpty,
              hintText: 'Hey what is your favorite restarurants',
              chipsInputController: chipsInputController,
            ),
          ]),
        ),
      ),
